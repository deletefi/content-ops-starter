  ...
  - type: PricingSection
    ...
    plans:
      - type: PricingPlan
        title: Базовый
        price: Бесплатно
        details: 'Фермеры, индивидуальные поставщики, локальные производители.'
        description: >
          Идеально для небольших фермерских хозяйств и локальных поставщиков,
          которые хотят начать использовать нашу платформу.
        features:
